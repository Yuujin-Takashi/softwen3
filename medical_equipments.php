...
{  ?>
        ...
        <td><a href="php_equip-update.php?equipmentsid=<?php echo $row['EquipmentID']; ?>&equipmentsname=<?php echo $row['EquipmentName']; ?>&equipmentsdesc=<?php echo $row['EquipmentDesc']; ?>&equipmentsqty=<?php echo $row['EquipmentQty']; ?>&equipmentsprice=<?php echo $row['EquipmentPrice']; ?>">Update</a></td>
        <td><a href="php_equip-delete.php?equipmentsid=<?php echo $row['EquipmentID']; ?>">Delete</a></td>
        </tr>
