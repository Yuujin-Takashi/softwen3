...
{  ?>
        ...
        <td><a href="php_hospital1-update.php?hospitalid=<?php echo $row['HospitalID']; ?>&hospitalname=<?php echo $row['HospitalName'];?>&hospitaladdress=<?php echo $row['HospitalAddress'];?>&hospitalcontactno=<?php echo $row['HospitalContactNo'];?>&hospitalemail=<?php echo $row['HospitalEmail'];?>">Update</a></td>
      </tr>
...
?>
  ...
  alert('Hospital Added Successfully.');
        window.location.href='hospital1.php';
        </script>
