...
{  ?>
        ...
        <td><a href="php_benefits-update.php?benefitid=<?php echo $row['BenefitID']; ?>&benefitname=<?php echo $row['BenefitName']; ?>&benefitdesc=<?php echo $row['BenefitDesc']; ?>&benefitfile=benefit_files/<?php echo $row['BenefitFile']; ?>">Update</a></td>
        <td><a href="php_benefits-delete.php?benefitid=<?php echo $row['BenefitID']; ?>">Delete</a></td>
        </tr>
...
<form name="add_benefits" action="php_medbenefit-add.php" method="post" enctype="multipart/form-data" class="w3-left" style="margin-bottom:50px">
