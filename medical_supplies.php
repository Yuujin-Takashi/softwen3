...
{  ?>
        ...
        <td><a href="php_supply-update.php?supplyid=<?php echo $row['SupplyID']; ?>&supplyname=<?php echo $row['SupplyName']; ?>&supplydesc=<?php echo $row['SupplyDesc']; ?>&supplyquantity=<?php echo $row['SupplyQty']; ?>&supplyprice=<?php echo $row['SupplyPrice']; ?>">Update</a></td>
        <td><a href="php_supply-delete.php?supplyid=<?php echo $row['SupplyID']; ?>">Delete</a></td>
        </tr>
